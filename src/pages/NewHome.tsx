...
import MobileStockPriceCard from '../components/MobileStockPriceCard';
import DiagnosisButtonRefactored from '../components/DiagnosisButtonRefactored';
...
export default function NewHome() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: 'url(/assets/shutterstock_1483507553.png)',
      }}
    >
      <RefactoredHeader />
      <ApiStatsDisplay />
      ...
      <div className="px-5 py-5 space-y-5">
        {loading && (
          <div className="text-center py-12">
            ...
            <p className="mt-4 text-blue-800 font-medium">株価データを読み込んでいます...</p>
          </div>
        )}

        {stockData && diagnosisState === 'initial' && (
          <>
            <MobileStockPriceCard
              info={stockData.info}
              latestPrice={stockData.prices[0]}
            />

            <DiagnosisButtonRefactored
        ...
        {diagnosisState === 'error' && (
          <div className="text-center py-20">
            <div className="max-w-2xl mx-auto p-8 bg-red-100 border border-red-400 rounded-2xl">
              <h3 className="text-xl font-bold text-red-600 mb-4">診断エラー</h3>
              ...
              <button
                ...
                className="px-8 py-3 bg-gradient-to-r from-deep-blue to-medium-blue text-white font-bold rounded-lg hover:from-blue-700 hover:to-blue-500 transition-all shadow-lg"
              >
                もう一度試す
              </button>
            </div>
