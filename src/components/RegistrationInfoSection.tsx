...
export default function RegistrationInfoSection() {
  return (
    <div className="relative overflow-hidden rounded-2xl shadow-xl" style={{ backgroundColor: '#061652' }}>
      ...
      <div className="relative z-10 p-5">
        <button className="w-full bg-gradient-to-r from-deep-blue to-medium-blue text-white font-bold py-3.5 px-6 rounded-xl transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] min-h-[52px]">
          <div className="flex items-center justify-center gap-3">
            <ChevronsLeft className="w-5 h-5 flex-shrink-0" />
            <span className="text-lg">登録情報</span>
            <ChevronsRight className="w-5 h-5 flex-shrink-0" />
          </div>
        </button>

        <p className="text-xs text-white/80 text-center mt-4 leading-relaxed px-2">
