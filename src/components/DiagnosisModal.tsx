    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black bg-opacity-75" style={{ touchAction: 'none' }}>
      <div className="relative w-full max-w-3xl max-h-[90vh]">
        ...
        <div className="relative bg-white rounded-lg shadow-blue-glow-lg overflow-hidden border-2 border-blue-400/50 mt-20" style={{ touchAction: 'auto' }}>
          ...
          <button
            onClick={onClose}
            className="relative z-10 p-2 hover:bg-blue-600 rounded-full transition-colors ml-4"
        ...
        <div ref={contentRef} className="overflow-y-auto max-h-[calc(90vh-240px)] px-6 py-6">
          ...
          <div className="mb-6">
            ...
            <button
              ...
              className="relative z-10 w-full bg-gradient-to-r from-green-600 to-green-700 text-white font-bold py-4 px-6 rounded-lg hover:from-green-700 hover:to-green-800 transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-3 text-lg mt-6"
              style={{ pointerEvents: 'auto' }}
            >
        ...
        <div className="sticky bottom-0 bg-gradient-to-t from-white via-white to-transparent px-6 py-6 border-t border-blue-200">
          <button
            ...
            className="relative z-10 w-full bg-blue-500 text-white font-semibold py-3 px-6 rounded-lg hover:bg-blue-600 transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed"
            style={{ pointerEvents: 'auto' }}
          >
            {isDownloading ? (
              <>
